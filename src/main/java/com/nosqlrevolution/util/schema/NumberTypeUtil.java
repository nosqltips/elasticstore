...
public class NumberTypeUtil {
    public static String generateSchema(NumberType anno, String name) {
        try {
            XContentBuilder builder = JsonXContent.contentBuilder();
            builder.startObject(name).field(Field.TYPE.getName(), anno.type().name().toLowerCase());
            ...
            Logger.getLogger(NumberTypeUtil.class.getName()).log(Level.SEVERE, null, ex);
        }
